...
update_module_status "$MODDIR" "FIXED" "✅ Emulator Fixed | KSU Hide Root 4 apps | @Hivirtus ❤️"

echo "╔══════════════════════════════════════════════════════╗"
echo "║  ✅ Emulator Detection Fixed                         ║"
echo "║  ✅ QEMU / Ranchu Hidden                             ║"
echo "║  ✅ Device Fingerprint Safe                          ║"
echo "╚══════════════════════════════════════════════════════╝"
echo ""
echo "Done! Please reboot your device to apply. ✅"
echo ""
echo "⚠️ Root hide — sirf ye 4 apps (KernelSU):"
echo "   BharatPe"
echo "   PhonePe"
echo "   FreeCharge"
echo "   Jio Finance"
echo "   → App list → Hide Root ON → Reboot"
echo ""
echo "Success!"
echo ""
